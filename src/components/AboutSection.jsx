      ...
      <div className="container">
        <div className="about-content">
          ...
          <div className="about-text">
            ...
            <p>{t('overviewKortibelt')}</p>
            <p>{t('overviewKortibeltS')}</p>

            <div className="features">

              <div className="feature"><i className="fas fa-thumbs-up"></i><span>{t('performance')}</span></div>
              <div className="feature"><i className="fas fa-wrench"></i><span>{t('fiabilite')}</span></div>
              <div className="feature"><i className="fas fa-cog"></i><span>{t('qualite')}</span></div>
              <div className="feature"><i className="fas fa-globe-africa"></i><span>{t('precisio')}</span></div>
          ...
          <div className="about-image">
            <img 
              ...
              alt="KORTIBELT AISGroup Tunisia" 
            />
          </div>
        </div>
